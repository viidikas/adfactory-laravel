...
async function loadAdminOrders() {
  try {
    ...
    document.getElementById('admin-orders-list').innerHTML = '<div style="color:var(--orange);font-size:10px;padding:20px;">Could not load — is proxy.py running?</div>';
  }
}
...
async function addUser() {
  ...
  if (r.ok) {
    ...
    loadUsers();       // also refresh login screen user list
  } else {
