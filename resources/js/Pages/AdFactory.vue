...
export default {
  ...
  methods: {
    ...
    <div class="view-panel" id="view-settings">
      ...
      <div class="card card-blue"><div class="card-title">&#127912; Designs (Templater)</div><div class="card-sub">Each design is a distinct graphic package in your AE project.</div><div id="designs-list"></div><div style="display:flex;gap:8px;margin-top:10px;"><button class="btn btn-secondary btn-sm" onclick="addDesign()">+ Add design</button><button class="btn btn-primary btn-sm" onclick="applyDesignsFormats()">&#10003; Save &amp; Apply</button></div></div>
