      ...
      <div id="settings-tab-designs" style="display:none;">
        <div class="card card-blue"><div class="card-title">&#127912; Designs for Growth Portal</div><div class="card-sub">Each design can have sample images per aspect ratio. These are shown to growth leads in the portal.</div><div id="admin-designs-list" style="margin-bottom:16px;"></div>
          <div style="background:var(--s3);border:1px solid var(--border2);border-radius:8px;padding:14px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:10px;"><input type="text" id="new-design-key" placeholder="Key (e.g. design1)" style="background:var(--s2);border:1px solid var(--border2);border-radius:6px;color:var(--text);padding:8px 12px;font-family:'DM Mono',monospace;font-size:11px;outline:none;width:160px;"><input type="text" id="new-design-label" placeholder="Label" style="background:var(--s2);border:1px solid var(--border2);border-radius:6px;color:var(--text);padding:8px 12px;font-family:'DM Mono',monospace;font-size:11px;outline:none;flex:1;min-width:180px;"><div style="display:flex;gap:6px;align-items:center;"><span style="font-size:10px;color:var(--muted2);">Brand:</span><label style="display:inline-flex;align-items:center;gap:4px;font-size:10px;color:var(--text);cursor:pointer;"><input type="radio" name="new-design-brand" value="Creditstar" checked style="accent-color:var(--accent);">Creditstar</label><label style="display:inline-flex;align-items:center;gap:4px;font-size:10px;color:var(--text);cursor:pointer;"><input type="radio" name="new-design-brand" value="Monefit" style="accent-color:var(--blue);">Monefit</label></div></div>
